...
<body style="overflow:hidden;" onload="showDropdownData();">
<form id="mainpage">
     <div class="topnav">
...
<div class="page-wrapper chiller-theme toggled">
 ...
 <i class="fa fa-angle-double-right" style="font-size:30px;color:white;"></i>
  ...
  <div class="rightbar">
            <div class="text" style="color: #104E8B" id="editDiv">
              <i class="fa fa-pencil-square" aria-hidden="true" style='font-size:50px;color:#104E8B'>
            </i>
              EDIT
            </div>
            <div class="text" style="color: #104E8B" >
               <i class="fa fa-lock" aria-hidden="true" style='font-size:50px;color:#104E8B'></i>
  ...
  <main class="page-content">
    <div class="container-fluid">
      ...
      <textarea id="textarea-data" class="editor" style=" left: 50%%;top: 50%; width: 982px; height: 429px; border: solid 1px;">
      </textarea>
    </div>
</div>
